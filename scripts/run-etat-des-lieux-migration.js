...
/**
 * Script pour exécuter la migration de la table etat_des_lieux_documents
 * 
 * Usage: node scripts/run-etat-des-lieux-migration.js
 */
...
async function runMigration() {
  try {
    console.log('🚀 Démarrage de la migration etat_des_lieux_documents...')
    
    // Lire le fichier SQL
    const sqlPath = path.join(__dirname, 'create-etat-des-lieux-table.sql')
