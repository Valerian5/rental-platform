...
export default function ApplicationDetailPage({ params }: { params: { id: string } }) {
  ...
  const getActionButtons = () => {
    ...
    // Bouton "Télécharger PDF" - disponible pour tous les statuts sauf "analyzing"
    const downloadPdfButton =
      application.status !== "analyzing" && rentalFile ? (
  ...
  const handleProposeVisit = () => {
    router.push(`/owner/applications/${application.id}/propose-visit`)
  }
  ...
  const handleContact = () => {
    toast.info("Fonctionnalité non implémentée")
  }
