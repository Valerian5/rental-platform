...
interface PropertyFormData {
  ...
  reference_rent_increased: number | null
  rent_supplement: number | null
  agency_fees_tenant: number | null
  inventory_fees_tenant: number | null

  // Nouveaux champs colocation
  colocation_possible: boolean
  max_colocation_occupants: number | null
...
export default function NewPropertyPage() {
  ...
  const [formData, setFormData] = useState<PropertyFormData>({
    ...
    reference_rent: null,
    reference_rent_increased: null,
    rent_supplement: null,
    agency_fees_tenant: null,
    inventory_fees_tenant: null,

    // Nouveaux champs colocation
    colocation_possible: false,
    max_colocation_occupants: null,
        ...
        {currentStep === 1 && (
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="border-t pt-6">
                <h3 className="text-lg font-semibold mb-4">Type de location</h3>
