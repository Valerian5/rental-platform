                          ...
                          <div key={key} className="border rounded-lg p-4">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <Select
                                value={element.state}
                                onValueChange={(value) =>
                                  updateRoomElement(rooms[currentRoomIndex].id, key, value, element.comment)
                                }
                              >
                            ...
                            <Textarea
                              ...
                              onChange={(e) =>
                                updateRoomElement(rooms[currentRoomIndex].id, key, element.state, e.target.value)
                              }
                              className="mt-2"
                            />
                          </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setRooms(
                            rooms.map((r, i) =>
                              i === currentRoomIndex ? { ...r, comment: e.target.value } : r
                            )
                          )
                        }
                      />
