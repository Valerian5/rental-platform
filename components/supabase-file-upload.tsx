...
export function SupabaseFileUpload({
  ...
  const uploadFiles = async () => {
    ...
    // Notifier les URLs uploadées avec logs pour debug
    ...
    console.log("📤 SupabaseFileUpload - Toutes les URLs:", allUrls)

    onFilesUploaded(uploadedUrls) // Envoyer seulement les nouvelles URLs
  }
      ...
      >
        <CardContent className="p-6 text-center">
          ...
          <p className="text-xs text-gray-500 mt-2">
            Maximum {maxFiles} fichiers • {acceptedTypes.join(", ")} • Stockage Supabase
          </p>
        </CardContent>
      </Card>
